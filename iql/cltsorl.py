...
def baseline(args):
    ...
    args_ex = parse_args("./iql/params.py")
    ...
    wandb.init(
        ...
        name=f"IQL_{args.dataset_types}_{args.dataset_ratios}_{args.dataset_size}_{args.seed}",
        config=args
    )
...
def without_CL(args):
    ...
    wandb.init(
        project=args.project,
        name=f"IQL(withoutCL)_{args.dataset_types}_{args.dataset_ratios}_{args.dataset_size}_{args.seed}",
        config=args
    )
    ...
    delta_model_path = f"./models/iql/{args.env}/{args.dataset_types[0]}_{args.dataset_types[1]}"
    ...
    ### Train DVE
    results_dir = f"./models/iql/{args.env}/{args.dataset_types[0]}_{args.dataset_types[1]}/dve"
...
def reward1(args):
    ...
    wandb.init(
        project=args.project,
        name=f"IQL(reward1)_{args.dataset_types}_{args.dataset_ratios}_{args.dataset_size}_{args.seed}",
        config=args
    )
    ...
    if not Path(f"./results/iql/reward1/{args.env}/{'_'.join(args.dataset_types)}").exists():
        os.makedirs(f"./results/iql/reward1/{args.env}/{'_'.join(args.dataset_types)}")
    np.save(f"./results/iql/reward1/{args.env}/{'_'.join(args.dataset_types)}/{args.seed}.npy", avg_rewards)
    df = {
        'critic_loss': [],
        'actor_loss': [],
        'environment': [],
    ...
    df.to_csv(f"./results/iql/reward1/{args.env}/{'_'.join(args.dataset_types)}/{args.seed}.csv")
...
def reward2(args):
    ...
    wandb.init(
        project=args.project,
        name=f"IQL(reward2)_{args.dataset_types}_{args.dataset_ratios}_{args.dataset_size}_{args.seed}",
        config=args
    )
    ...
    # for metric in logs:
    #     wandb.log(metric)
    if not Path(f"./results/iql/reward2/{args.env}/{'_'.join(args.dataset_types)}").exists():
        os.makedirs(f"./results/iql/reward2/{args.env}/{'_'.join(args.dataset_types)}")
    np.save(f"./results/iql/reward2/{args.env}/{'_'.join(args.dataset_types)}/{args.seed}.npy", avg_rewards)
    df = {
        'critic_loss': [],
        'actor_loss': [],
        'environment': [],
    ...
    for log in logs:
        ...
        df['value_scale'].append(log['value_scale'])
    df = pd.DataFrame(data=df)
    df.to_csv(f"./results/iql/reward2/{args.env}/{'_'.join(args.dataset_types)}/{args.seed}.csv")
...
def pair_impact(args):
    ...
    def run():
        ...
        wandb.init(
            project=args.project,
            name=f"IQL(pairimpact)_{args.dataset_types}_{args.dataset_ratios}_{args.dataset_size}_delta{args.dcla_ratio}_lambda{args.modify_ratio}_{args.seed}",
            config=args
        )
        ...
        policy_target = d3rlpy.algos.IQL(
            actor_learning_rate=3e-4,
            critic_learning_rate=3e-4,
            gamma=0.99,
            tau=0.005,
        ...
        policy_source = d3rlpy.algos.IQL(
            actor_learning_rate=3e-4,
            critic_learning_rate=3e-4,
            gamma=0.99,
            tau=0.005,
...
def without_TS(args):
    ...
    wandb.init(
        project=args.project,
        name=f"IQL(trajValuation)_{args.dataset_types}_{args.dataset_ratios}_{args.dataset_size}_{args.seed}",
        config=args
    )
